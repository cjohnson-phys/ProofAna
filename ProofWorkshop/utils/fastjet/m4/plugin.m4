...
dnl end of default plugin settings --- don't modify this line
    ...
    AH_TEMPLATE(ENABLE_PLUGIN_FLAVKT,           [checks if the FlavKt plugin is enabled])
...
[
	...
	CONFIG_SUMMARY+="           FlavKt            "${ENABLE_FLAVKT}"\n"
	])
