...
bool PassedTriggerEF(double etaOff, double phiOff, const std::vector<int> *EFdecision, int &EFindex, 
		     unsigned int nEFObject, const std::vector<float> *EFetaVector, const std::vector<float> *EFphiVector);
