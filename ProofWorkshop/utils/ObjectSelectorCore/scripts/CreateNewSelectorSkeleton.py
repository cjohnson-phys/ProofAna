...
def CreateTSelectorSourceFile( _packageName, _selectorName, _doubleCutNameList ) :
    ...
    for doubleCutName in _doubleCutNameList:
        ...
        pass
    for doubleCutName in _doubleCutNameList:
        _tcLineList.append('  m_cutName%s("%s"),\n' % ( doubleCutName, doubleCutName ) )
    ...
    for doubleCutName in _doubleCutNameList:
        ...
        _tcLineList.append('  m_cutPosition%s = m_accept.addCut( m_cutName%s, Form("var0 < %%g", %s) );\n' % ( doubleCutName, doubleCutName, doubleCutName ) )
...
def CreateTSelectorHeaderFile( _packageName, _selectorName, _doubleCutNameList  ) :
    ...
    for doubleCutName in _doubleCutNameList:
        _cutsGiven = True
        _thLineList.append('    /** Name of the %s cut */\n' % doubleCutName )
        _thLineList.append('    const TString m_cutName%s;\n' % doubleCutName )
        _thLineList.append('\n')
...
def CreateARASelectorSourceFile( _packageName, _selectorName, _doubleCutNameList ) :
    ...
    _aracLineList.append('  AraToolBase(pmgr),\n')
    _aracLineList.append('  ARASelectorToolBase(pmgr),\n')
    _aracLineList.append('  m_rootTool(0)\n')
    _aracLineList.append('{\n')
    _aracLineList.append('  m_rootTool = new Root::T%s();\n' % _selectorName )
...
def CreateAthSelectorFile( _packageName, _selectorName ) :
    ...
    _athhLineList.append('#include "ObjectSelectorCore/IAthSelectorTool.h"\n')
    _athhLineList.append('\n')
    ...
    _athhLineList.append('    public  AraAlgToolWrapper< ARA%s >\n' % _selectorName )
    _athhLineList.append('{\n')
    _athhLineList.append('\n')
    ...
    _athhLineList.append('  {\n')
    _athhLineList.append('    AlgTool::declareInterface< IAthSelectorTool >(this);\n' )
    _athhLineList.append('  };\n')
    _athhLineList.append('\n')
    _athhLineList.append('  /** We have to declare the main method here because the IAthXXXTool method is declared as pure virtual */\n')
    _athhLineList.append('  virtual const Root::TAccept& accept( const INavigable4Momentum* part )\n')
    _athhLineList.append('  {\n')
    _athhLineList.append('    return this->getTool()->accept(part);\n')
    _athhLineList.append('  };\n')
    _athhLineList.append('\n')
    _athhLineList.append('\n')
