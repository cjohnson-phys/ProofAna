...
// from TTree EventBuilder_Eflow/EventBuilder_Eflow
// found on file: NTUP_JETMET.543738._000084.root.2
//////////////////////////////////////////////////////////

#ifndef EventBuilder_Eflow_h
#define EventBuilder_Eflow_h
...
class EventBuilder_Eflow : public EventBuilderBase {
public :
  ...
  vector<float> closeBy;
   ...
   EventBuilder_Eflow(TTree * /*tree*/ =0);
   virtual ~EventBuilder_Eflow();

   AnalysisBase* fEvt;

   MomentObj* barcode_link;

   ClassDef(EventBuilder_Eflow,0);
...
#ifdef EventBuilder_Eflow_cxx

Bool_t EventBuilder_Eflow::Notify()
{
...
#endif // #ifdef EventBuilder_Eflow_cxx
