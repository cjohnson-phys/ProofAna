...
public:
  /// construct a flavour info from a pdg code. This can handle most
  ...
  /// construct a flavour info object from the individual flavours
  FlavInfo (int n_d, int n_u, int n_s, int n_c, int n_b, int n_t, int flags = 0);

  /// return the net number of quarks of flavour iflv 
...
public:
  ...
  /// return the flavour of the forward-going (more positive rapidity) beam
  ...
  /// return the flavour of the backward-going (more negative rapidity) beam
  /// at the stage of the clustering with n_exclusive_jets
